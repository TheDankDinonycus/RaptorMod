...
public class ModelCompy extends ModelBase 
{
    ...
    public ModelCompy() {
        ...
        this.RightThigh.setRotationPoint(0.0F, 0.0F, -0.7F);
        this.RightThigh.addBox(0.0F, 0.0F, 0.0F, 4, 6, 2, 0.0F);
        this.setRotateAngle(RightThigh, 0.0F, 0.0F, 0.2530727415391778F);
        this.LeftMiddle = new ModelRenderer(this, 43, 16);
        this.LeftMiddle.setRotationPoint(0.0F, 5.6F, 0.0F);
        this.LeftMiddle.addBox(0.0F, 0.0F, 0.0F, 2, 5, 2, 0.0F);
        this.setRotateAngle(LeftMiddle, 0.0F, 0.0F, -0.8726646259971648F);
        this.Body = new ModelRenderer(this, 0, 0);
        this.Body.setRotationPoint(-2.3F, 12.8F, 3.0F);
        this.Body.addBox(0.0F, 0.0F, 0.0F, 8, 5, 4, 0.0F);
        this.setRotateAngle(Body, 0.0F, 1.583013631558857F, 0.0F);
        this.Head = new ModelRenderer(this, 7, 13);
        this.Head.setRotationPoint(0.2F, -2.0F, 0.0F);
        ...
        this.setRotateAngle(RightHand, 0.0F, 0.0F, -0.20943951023931953F);
        ...
        this.LeftThigh.setRotationPoint(0.0F, 0.0F, 3.5F);
        this.LeftThigh.addBox(0.0F, 0.0F, 0.0F, 4, 6, 2, 0.0F);
        this.setRotateAngle(LeftThigh, 0.0F, 0.0F, 0.2530727415391778F);
        ...
        this.Neck2.setRotationPoint(3.9F, -1.3F, -0.1F);
        this.Neck2.addBox(0.0F, 0.0F, 0.0F, 2, 4, 3, 0.0F);
        this.setRotateAngle(Neck2, 0.0F, 0.0F, 0.41015237421866746F);
        this.Tail1 = new ModelRenderer(this, 24, 0);
        this.Tail1.setRotationPoint(-3.8F, 0.0F, 1.0F);
        ...
        this.LeftArm.setRotationPoint(6.0F, 1.5F, 3.6F);
        ...
        this.Neck1.setRotationPoint(3.7F, 0.7F, 1.0F);
        ...
        this.setRotateAngle(LeftHand, 0.0F, 0.0F, -0.20943951023931953F);
        this.RightMiddle = new ModelRenderer(this, 35, 12);
        this.RightMiddle.setRotationPoint(0.0F, 5.6F, 0.0F);
        this.RightMiddle.addBox(0.0F, 0.0F, 0.0F, 2, 5, 2, 0.0F);
        this.setRotateAngle(RightMiddle, 0.0F, 0.0F, -0.8726646259971648F);
        this.TopMouth = new ModelRenderer(this, 49, 0);
        ...
        this.BottomMouth = new ModelRenderer(this, 21, 14);
