...
public class ModelCompy extends ModelBase {
    ...
    public ModelCompy() {
        ...
        this.setRotateAngle(RightThigh, 0.0F, 0.0F, 0.23945917337362213F);
        ...
        this.setRotateAngle(LeftThigh, 0.0F, 0.0F, 0.239459173373622F);
    ...
    {
    	this.RightThigh.rotateAngleZ = MathHelper.cos(limbSwing = 0.2222F) * 1.4F * limbSwingAmount;
    	this.LeftThigh.rotateAngleZ = MathHelper.cos(limbSwing = 0.2222F + (float)Math.PI) * 1.4F * limbSwingAmount;
